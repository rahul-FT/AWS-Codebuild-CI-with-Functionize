    ...
    stages {
        stage('Functionize-CLI') {
          agent {
            ...
            steps {
              sh 'cd /var/lib/jenkins/workspace/Jenkins CI With Functionize@tmp'
              sh 'ls -al'
              ...
              // sh 'cd /opt/functionizecli && npm install'
              // sh 'cd /opt/functionizecli && npm install -g'
              // sh 'cd /opt/functionizecli && ls -al'
              // sh 'cd /opt/functionizecli && mv config-sample.js config.js'
              // sh 'cd /opt/functionizecli echo "alias functionize-cli=\'node /opt/functionizecli/functionize.js\'" >> ~/.bash_profile'
